...
class Application(fix.Application):
    ...
    def fromApp(self, message, sessionID): 
        ...
        message_types = {
            fix.MsgType_NewOrderSingle: self.on_new_order,
            fix.MsgType_OrderCancelRequest: self.on_cancel_request,
            fix.MsgType_OrderCancelReplaceRequest: self.on_replace_request,
    ...
    def on_new_order(self, message):
        ...
        # testing
        self.test_replies(orderID, fix.OrdStatus_NEW, fix.ExecType_NEW, message_details)
    ...
    def on_cancel_request(self, message):
        ...
        # testing
        self.test_replies(orderID, fix.OrdStatus_CANCELED, fix.ExecType_CANCELED, message_details, reject=True)
    ...
    def on_replace_request(self, message):
        ...
        # testing
        self.test_replies(orderID, fix.OrdStatus_PENDING_REPLACE, fix.ExecType_REPLACE, message_details)
    ...
    def send_cancel_replace_reject(self, orderID, orderStatus, details):
        ...
        reject_fields = {
            ...
            fix.OrigClOrdID:details['original_clientID'],
    ...
    def send_execution_report(self, orderID, orderStatus, execType, details):
        ...
        order_specific_fields = {
            ...
            fix.ExecType_CANCELED :{
                fix.OrigClOrdID:'original_clientID',
                fix.OrderQty:'quantity',
            },
    ...
    def test_replies(self, orderID, orderStatus, execType, message_details, reject=False):
        ...
        if reject:
            reject_details = {
                'original_clientID':message_details['original_clientID'],
